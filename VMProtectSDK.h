...
VMP_IMPORT void VMP_API VMProtectBeginMutationVirtualization(const char *);
VMP_IMPORT void VMP_API VMProtectBeginMutationMutation(const char *);
VMP_IMPORT void VMP_API VMProtectBeginMutationUltra(const char *);
VMP_IMPORT void VMP_API VMProtectBeginMutationVirtualizationLockByKey(const char *);
VMP_IMPORT void VMP_API VMProtectBeginMutationUltraLockByKey(const char *);
...
VMP_IMPORT DWORD VMP_API VMProtectSetSerialNumber(const char *serial);
VMP_IMPORT DWORD VMP_API VMProtectGetSerialNumberState();
VMP_IMPORT bool VMP_API VMProtectGetSerialNumberData(VMProtectSerialNumberData *data, DWORD size);
VMP_IMPORT DWORD VMP_API VMProtectGetCurrentHWID(char *hwid, DWORD size);
...
VMP_IMPORT DWORD VMP_API VMProtectActivateLicense(const char *code, char *serial, DWORD size);
VMP_IMPORT DWORD VMP_API VMProtectDeactivateLicense(const char *serial);
VMP_IMPORT DWORD VMP_API VMProtectGetOfflineActivationString(const char *code, char *buf, DWORD size);
VMP_IMPORT DWORD VMP_API VMProtectGetOfflineDeactivationString(const char *serial, char *buf, DWORD size);
